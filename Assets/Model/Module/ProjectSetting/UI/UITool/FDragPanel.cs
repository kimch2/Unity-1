 ...
 *  auth: 范高征
 *  date: 2015-4-30
 *  desc: UI拖动类，解决了拖动过程中同时旋转的问题。改自DragPanel
...
public class FDragPanel : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IDragHandler, IEndDragHandler, IBeginDragHandler
{
