...
namespace ETModel
{
	...
	public abstract class Component : Object, IDisposable
	{
...
#if !SERVER
		public static GameObject Global { get; } = GameObject.Find("/[Application]");
        ...
        public async ETTask SetGameObject(string assetName)
        {
            var go = await UnityEngine.AddressableAssets.Addressables.LoadAssetAsync<GameObject>(assetName).Task;
