...
namespace wxb
{
    ...
    public static class hotMgr
    {
        ...
        public static async Task Init(IResLoad resLoad = null)
        {
            if (appdomain != null)
                return;
        ...
        static public async Task InitHotModule()
        {
            ...
            try
            {
                DllStream = CopyStream(await ResLoad.GetStream("DyncDll.dll"));
                if (DllStream != null)
                {
#if USE_PDB
                    SymbolStream = CopyStream(await ResLoad.GetStream("DyncDll.pdb"));
                    appdomain.LoadAssembly(DllStream, SymbolStream, new Mono.Cecil.Pdb.PdbReaderProvider());
#elif USE_MDB
                    SymbolStream = CopyStream(await ResLoad.GetStream("DyncDll.mdb"));
