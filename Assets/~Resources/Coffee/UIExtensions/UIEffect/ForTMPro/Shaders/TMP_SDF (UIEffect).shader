...
SubShader {
	...
	Pass {
		...
		#include "Assets/AddressableAssets/Resources/TextMesh Pro/Shaders/TMPro_Properties.cginc"
		#include "Assets/AddressableAssets/Resources/TextMesh Pro/Shaders/TMPro.cginc"
		
		#define UI_EFFECT 1
		#include "Assets/AddressableAssets/Resources/Coffee/UIExtensions/UIEffect/Shaders/UI-Effect.cginc"
